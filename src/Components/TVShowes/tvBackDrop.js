...
const TvBackdropCard = ()=>{
    ...
    return(<div className=" flex justify-center pb-[1rem]  border-b-[0.1rem] border-slate-700 w-full h-[auto] relative"> 
    {
    ...
    allowFullScreen></iframe>
        ...
        <p className="leading-tight font-bold text-slate-300 mt-[10%] p-0 text-4xl xxsm:text-[0.9rem] xsm:text-[1rem] l sm:text-[1.8rem] md:text-[1.8rem] lg:text-[1.9rem] xl:text-[1.9rem] 2xl:text-[1.9rem] 3xl:text-[1.9rem] 4xl:text-[1.9rem] 5xl:text-[1.9rem] 6xl:text-[2rem]">{TV_Series?.results[1]?.name}</p>
        <p className=" leading-tight text-slate-300 pb-[0.2rem] text-2xl xxsm:text-[0.8rem] xsm:text-[1rem] sm:text-lg md:text-xl lg:text-xl xl:text-xl 2xl:text-xl 3xl:text-xl 4xl:text-2xl 5xl:text-2xl 6xl:text-2xl">{TV_Series?.results[1]?.tagline}</p>
