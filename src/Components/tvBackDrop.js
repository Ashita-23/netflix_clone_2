...
import{ useTV_Series} from "../utils/useProjectApi"
const TvBackdropCard = ()=>{
    ...
    {!TV_Series ?<div className="bg-black flex justify-left">
 ...
 <div className="  p-2 bg-black  flex flex-col text-white xxsm:px-3 xsm: sm:w-[70%] md:w-[70%] px-4 lg:w-[70%] xl:w-[70%] 2xl:w-[70%] 3xl:w-[70%] 4xl:w-[70%] 5xl:w-[70%] 6xl:w-[70%] ">
        <p className="text-[1.2rem] font-semibold sm: md:text-3xl lg:text-3xl xl:text-3xl 2xl:text-3xl 3xl:text-3xl 4xl:text-3xl 5xl:text-3xl 6xl:text-3xl">{TV_Series?.results[0]?.name}</p>
        <p className="text-[0.8rem] p-1 xxsm:text-[0.7rem] xsm:text-[0.7rem] md:text-md lg:text-md xl:text-md 2xl:text-md 3xl:text-md 4xl:text-md 5xl:text-md 6xl:text-md ">{TV_Series?.results[0]?.overview}</p>
