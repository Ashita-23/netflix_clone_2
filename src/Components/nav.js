...
const TvNav = ()=>{
  ...
  {IsTVCard?<button className="text-white bg-red-600 px-4 py-1 rounded-md" onClick={()=>dispatch( AddShowTvCard(false))} >Search</button>:
    <button className="text-white bg-red-600 px-4 py-1 rounded-md" onClick={()=>dispatch( AddShowTvCard(true))} >Tv</button>} 
